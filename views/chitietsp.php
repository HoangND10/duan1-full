                ...
                <div class="product-details-content quickview-content">
                    ...
                    <div class="pricing-meta">
                        <ul>
                            ...
                            <?php echo '<li class="old-price not-cut">' . $gia . ' đ</li>' ?>
                    ...
                    <div class="pro-details-quality">
                        <div class="pro-details-cart">
                            ...
                            ?>
                            <!-- <button class="add-cart btn btn-primary btn-hover-primary" href="index.php?act=addtocart">Add to cart</button> -->
                        </div>
                    </div>
            ...
            <div class="tab-content description-review-bottom">
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="row">
                        ...
                        <div class="col-lg-5 float-md-right"> <!-- Sử dụng float-md-right để đẩy sang phải trên màn hình lớn hơn hoặc bằng medium -->
                                ...
                                <div class="ratting-form">
                                    <form action="index.php?act=binhluan" method="post">
                                        <div class="star-box">
                                            ...
                                            <!-- Các dấu sao xếp hạng ở đây -->
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="rating-form-style form-submit">
                                                    <input type="hidden" name="idsp" value="<?= $idsp ?>">
                                                    <textarea name="noidung" placeholder="Message"></textarea>
                                                    <button class="btn btn-primary btn-hover-color-primary " name="binhluan" type="submit" value="Submit">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
